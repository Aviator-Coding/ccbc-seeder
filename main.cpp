...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "CCBC-seeder\n"
...
//Mainnet Seeds
static const string mainnet_seeds[] = { "s01.ccbcoin.club", 
                                        "s02.ccbcoin.club" , 
                                        "s03.ccbcoin.club" , 
                                        "s04.ccbcoin.club", 
                                        "s05.ccbcoin.club", 
                                        ...
                                        ""};
//Testnet Seeds
static const string testnet_seeds[] = { "s01test.ccbcoin.club", 
                                        "s02test.ccbcoin.club" , 
                                        ""};
...
int main(int argc, char **argv) {
  ...
  if (f) {
    ...
    if (opts.fWipeBan)
    {
        printf("Cleaning Bannlist out\n");
        db.banned.clear();
    }

    if (opts.fWipeIgnore)
    {   
        printf("Ressetting Bans\n");
        db.ResetIgnores();
    }
    printf("done\n");
  }
  ...
  {
    printf("Unable to Open dnsseed.dat...");
  }
